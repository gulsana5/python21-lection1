# "====================Tuple=================="
# кортеж - неизменяемый, индексируемый, упорядочный, итирируемый тип данных, предназначенный
# для хранения любых данных в определенном порядке (в целом не отличается от списков, просто не изменяемый, 
# поэтому занимает меньше памяти)

tuple1 = (1,2,3) # (1,2,3)
tuple2 = ('hello', 2.5, 10, (2,3), [1,2,3])
