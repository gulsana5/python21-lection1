...
# множественное наследования - наследование от 2 или более классов
...
# 1. проблема ромба - решенная проблема начиная с версии 2.3 (с помощью МРО
...
# 2. проблема перекрестного насдедования - нерешенная проблема
