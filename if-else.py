...
# "=================None Type======="
# # None - тип данных с одним значением None,который используется для обозначения пустых значений или отсутствие значения
# bool(None) # False
# bool('None') #  True
...
# # is это проверко на полное соответствие
